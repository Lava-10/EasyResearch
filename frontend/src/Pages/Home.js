...
const Home = () => {
  return (
    <div className="mainbox">
      <h1><span class="highlight">E</span>asy<span class="highlight">I</span>Research</h1>
      ...
      <div className="contentBox">
        <div id='imgContentBar'>
          <div id='infoBox' className="about">
            ...
            <p>
              easyResearch is a browser-based tool for generating visual abstracts, built with Gemini. 
              Simply feed it a research paper and it will generate you a visual abstract!
            </p>
            <p>
              We built easyResearch to help <span className="blueBold">summarize</span> long research papers into 
